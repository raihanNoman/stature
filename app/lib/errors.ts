...
import {
  ...
  STATURE_ERROR__ALREADY_VERIFIED,
  STATURE_ERROR__INSUFFICIENT_FUNDS,
  STATURE_ERROR__INVALID_SOURCE_OWNER,
  STATURE_ERROR__MISMATCHED_TARGET_PROGRAM,
  STATURE_ERROR__PROGRAM_IN_BAD_STANDING,
  STATURE_ERROR__UNAUTHORIZED,
...
const STATURE_ERROR_CODES: Record<number, StatureError> = {
  ...
  [STATURE_ERROR__ALREADY_VERIFIED]: STATURE_ERROR__ALREADY_VERIFIED,

  [STATURE_ERROR__INSUFFICIENT_FUNDS]: STATURE_ERROR__INSUFFICIENT_FUNDS,

  [STATURE_ERROR__INVALID_SOURCE_OWNER]: STATURE_ERROR__INVALID_SOURCE_OWNER,
  ...
  [STATURE_ERROR__UNAUTHORIZED]: STATURE_ERROR__UNAUTHORIZED,
